	...
	; o Sombra para el misil teledirigido.
	...
	;   o Técnica 3: Llevar MOBS por la izquierda.
        ; o Menos flicker en paredes
	; o Posible pantalla intermedia entre espacio y fortaleza.
	; o Posible tabla de puntuaciones.
...
montaje:	RMB 1		; Indica si hizo montaje de sprites
montaje_y:	RMB 1		; Coordenada Y antes de montaje
...
@@166:	MVII #0,R0	; Nivel inicial al jugar !!!
@@167:	MVO R0,nivel
        CALl sel_nivel2
...
@@98:	MVO R1,xe3d1
	...
	BNE @@155
@@154:	MVII #0,R2	; Truco para evitar colisión con explosión
	MVO R2,colision0
	MVO R2,colision2
@@155:	MVII #5,R1
...
@@vi1:  ADDI #$24,R0
	...
	; Determina si dibuja sprites de forma especial
@@vi42:
	MVII #0,R0
	MVO R0,montaje
	MVI nivel,R0
...
mascara_piso:	PROC
	DECLE $0000,$0000,$0000,$FF0F
	DECLE $0000,$0000,$FF0F,$FFFF
	DECLE $0000,$FF0F,$FFFF,$FFFF
	DECLE $FF0F,$FFFF,$FFFF,$FFFF
	DECLE $F0FF,$0000,$0000,$0000
	DECLE $FFFF,$F0FF,$0000,$0000
	DECLE $FFFF,$FFFF,$F0FF,$0000
	DECLE $FFFF,$FFFF,$FFFF,$F0FF
	ENDP
...
mensaje_3:
	;   "Space Raid, by:     "
	DECLE $0033*8+7,$0050*8+7,$0041*8+7,$0043*8+7,$0045*8+7
	DECLE $0000*8+7,$0032*8+7,$0041*8+7,$0049*8+7,$0044*8+7
	DECLE $000c*8+7,$0000*8+7,$0042*8+7,$0059*8+7,$001a*8+7
	DECLE $0000,$0000,$0000,$0000,$0000
	;   "  Oscar Toledo G.   "
	DECLE $0000*8+6,$0000*8+6,$002F*8+6,$0053*8+6,$0043*8+6
	DECLE $0041*8+6,$0052*8+6,$0000*8+6,$0034*8+6,$004F*8+6
	DECLE $004C*8+6,$0045*8+6,$0044*8+6,$004F*8+6,$0000*8+6
	DECLE $0027*8+6,$000E*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "Published by:       "
	DECLE $0030*8+7,$0055*8+7,$0042*8+7,$004C*8+7,$0049*8+7
	DECLE $0053*8+7,$0048*8+7,$0045*8+7,$0044*8+7,$0000*8+7
	DECLE $0042*8+7,$0059*8+7,$001a*8+7,$0000*8+7,$0000*8+7
	DECLE $0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7
	;   "  Collectorvision   "
	DECLE $0000*8+6,$0000*8+6,$0023*8+6,$004F*8+6,$004C*8+6
	DECLE $004C*8+6,$0045*8+6,$0043*8+6,$0054*8+6,$004F*8+6
	DECLE $0052*8+6,$0056*8+6,$0049*8+6,$0053*8+6,$0049*8+6
	DECLE $004F*8+6,$004E*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "  Harvey deKleine   "
	...
	;   "  J.F.Dupuis        "
	DECLE $0000*8+6,$0000*8+6,$002A*8+6,$000E*8+6,$0026*8+6
	DECLE $000E*8+6,$0024*8+6,$0055*8+6,$0050*8+6,$0055*8+6
	DECLE $0049*8+6,$0053*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	DECLE $0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "  Vince Godefroy    "
	DECLE $0000*8+6,$0000*8+6,$0036*8+6,$0049*8+6,$004E*8+6
	DECLE $0043*8+6,$0045*8+6,$0000*8+6,$0027*8+6,$004f*8+6
	DECLE $0044*8+6,$0045*8+6,$0046*8+6,$0052*8+6,$004f*8+6
	DECLE $0059*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
        ;   "  Tobie St-Aubin    "
	DECLE $0000*8+6,$0000*8+6,$0034*8+6,$004f*8+6,$0042*8+6
	DECLE $0049*8+6,$0045*8+6,$0000*8+6,$0033*8+6,$0054*8+6
	DECLE $000d*8+6,$0021*8+6,$0055*8+6,$0042*8+6,$0049*8+6
	DECLE $004e*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "Beta testing:       "
	DECLE $0022*8+7,$0045*8+7,$0054*8+7,$0041*8+7,$0000*8+7
	DECLE $0054*8+7,$0045*8+7,$0053*8+7,$0054*8+7,$0049*8+7
	DECLE $004e*8+7,$0047*8+7,$001a*8+7,$0000*8+7,$0000*8+7
	DECLE $0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7
	;   "  Mark Ball         "
	DECLE $0000*8+6,$0000*8+6,$002d*8+6,$0041*8+6,$0052*8+6
	DECLE $004b*8+6,$0000*8+6,$0022*8+6,$0041*8+6,$004c*8+6
	DECLE $004c*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	DECLE $0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "  Christian Martin  "
	DECLE $0000*8+6,$0000*8+6,$0023*8+6,$0048*8+6,$0052*8+6
	DECLE $0049*8+6,$0053*8+6,$0054*8+6,$0049*8+6,$0041*8+6
	DECLE $004e*8+6,$0000*8+6,$002d*8+6,$0041*8+6,$0052*8+6
	DECLE $0054*8+6,$0049*8+6,$004e*8+6,$0000*8+6,$0000*8+6
	;   "ROM Jan/24/2014     "
	DECLE $0032*8+3,$002f*8+3,$002d*8+3,$0000*8+3,$002a*8+3
	DECLE $0041*8+3,$004e*8+3,$000f*8+3,$0012*8+3,$0014*8+3
	DECLE $000f*8+3,$0012*8+3,$0010*8+3,$0011*8+3,$0014*8+3
	DECLE $0000*8+3,$0000*8+3,$0000*8+3,$0000*8+3,$0000*8+3
