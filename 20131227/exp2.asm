	...
	;                        despacio. Se agrega sonido para la mirilla.
        ...
        ; Próxima etiqueta: @@142
        
        ; Por hacer:
        ; o Pantalla de presentación (creando con bloques 4x4 como dibujando)
	...
	; o Bug: si pierde el juego en espacio se ve un cuadro de basura.
