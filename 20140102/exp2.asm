...
@@vi31:	MVO R0,offset1temp
	...
	; Paredes
@@vi27:
	; !!! Montar 4 sprites en horizontal.
	; !!! Clipping en parte superior (16 a 8 pixeles si necesario)
	; !!! Cargar los sprites
@@vi26:
