...
mensaje_3:
	...
	DECLE $0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7,$0000*8+7
	;   "  cmart604, ed1475, "
	DECLE $0000*8+6,$0000*8+6,$0043*8+6,$004d*8+6,$0041*8+6
	DECLE $0052*8+6,$0054*8+6,$0016*8+6,$0010*8+6,$0014*8+6
	DECLE $000c*8+6,$0000*8+6,$0045*8+6,$0044*8+6,$0011*8+6
	DECLE $0014*8+6,$0017*8+6,$0015*8+6,$000c*8+6,$0000*8+6
	;   "  GroovyBee         "
	DECLE $0000*8+6,$0000*8+6,$0027*8+6,$0052*8+6,$004f*8+6
	DECLE $004f*8+6,$0056*8+6,$0059*8+6,$0022*8+6,$0045*8+6
	DECLE $0045*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	DECLE $0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6,$0000*8+6
	;   "ROM Feb/14/2014     "
	DECLE $0032*8+3,$002f*8+3,$002d*8+3,$0000*8+3,$0026*8+3
	DECLE $0045*8+3,$0042*8+3,$000f*8+3,$0011*8+3,$0014*8+3
	DECLE $000f*8+3,$0012*8+3,$0010*8+3,$0011*8+3,$0014*8+3
	DECLE $0000*8+3,$0000*8+3,$0000*8+3,$0000*8+3,$0000*8+3

mensaje_4:
	;   "Great Warriors"
	DECLE $0027*8+5,$0052*8+5,$0045*8+5,$0041*8+5,$0054*8+5
	DECLE $0000*8+5,$0037*8+5,$0041*8+5,$0052*8+5,$0052*8+5
	DECLE $0049*8+5,$004f*8+5,$0052*8+5,$0053*8+5
