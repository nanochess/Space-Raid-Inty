...
vida_extra:	RMB 1		; Indica si dio vida extra
...
@@0:    
	MVII #$0fe,R1           ; 240 palabras + 14 de sonido
        ...
        CALL FILLZERO
	MVII #_SYSTEM-$310,R1           ; 16 palabras
...
@@178:	DECR R0
	...
	CALL boton_oprimido
	BEQ @@178
	MVII #10,R0		; En demo oprimir botón aborta
	MVO R0,califica
...
@@164:	CLRR R0
	...
	MVO R0,sonido_base0
	CALL reproduce_sonido
	B reinicio3	; Reinicio y verifica si califica
...
@@172:
	...
	MVO R0,sonido_base0
	CALL reproduce_sonido
	B reinicio2	; Reinicio sin calificar
...
@@4:    MVO R2,x_jugador
	...
	BEQ @@165	; No, salta.
	CALL boton_oprimido
	BNE @@172	; ¿Botón oprimido? aborta demo.
...
@@138:	MVII #sonido_6-base_sonido,R0
	...
	CMPI #$A0,R1		; ¿Robotote?
	BEQ @@139
	MVII #sonido_10-base_sonido,R0
	MVI vida_extra,R1	; ¿Vida extra?
	TSTR R1
	BNE @@139
	MVII #sonido_11-base_sonido,R0
	MVI gasolina,R1		; ¿Gasolina baja?
	CMPI #$10,R1
	BLE @@139
	CLRR R0
...
@@3:	SLR R0,2
	...
	BLT @@2
	MVI puntos_vida,R0
	SLL R0,1	; Duplica puntos requeridos
;	ADDI #200,R0	; Antes, 04-mar-2014. Muy fácil
	...
	INCR R0
	MVO R0,vidas
	MVII #46,R0	; Sonido de vida extra
	MVO R0,vida_extra
@@2:	JR R5
...
tabla_puntos:	PROC
	DECLE $02	; $40 - Avión chico
	DECLE $00	; $48 - Explosión
	DECLE $02	; $50 - Cañón mirando a la derecha
	DECLE $00	; $58 - Explosión
	DECLE $00	; $60 - Agujero
	DECLE $02	; $68 - Cañón mirando a la izquierda
	DECLE $01	; $70 - Combustible
	DECLE $02	; $78 - Antena
	DECLE $00	; $80 - Agujero disparando
	DECLE $01	; $88 - Misil vertical
	DECLE $03	; $90 - Alienígena
	DECLE $05	; $98 - Misil teledirigido
	DECLE $19	; $a0 - Robotote
	DECLE $00	; $a8 - Parte del robotote
	DECLE $00	; $b0 - Adorno
	DECLE $00	; $b8 - Electricidad
	DECLE $0a	; $c0 - Satélite
	ENDP
...
@@vi99:	MVO@ R2,R5
	...
	MVO@ R2,R5
	INCR R5
	MVII #$0F*8+$0006,R2	; +1 comienza en dígito cero
	TSTR R0
	BPL @@vi98
	CLRR R0
	MVII #$0006-8,R2	; +1 será espacio
@@vi98:	DIGITO 1
	MVO@ R2,R5
	;
	...
	MVI gasolina,R0
	MVII #$0003,R3
	CMPI #$10,R0	; ¿Queda poca gasolina?
	BGT @@168	; No, salta.
	MVI vidas,R1
	TSTR R1		; ¿Ya explotó?
	BMI @@168	; Sí, salta, no parpadea.
	MVI cuadro,R1
	ANDI #8,R1	; ¿Tiempo de parpadear?
	BEQ @@168	; No, salta.
	MVII #$0002,R3
@@168:	ADDI #$07,R0
	SLR R0,2
...
sonido_10:
	DECLE $0F02,3579545/32/431
	DECLE $0002,3579545/32/431
	DECLE $0F02,3579545/32/539
	DECLE $0002,3579545/32/539
	DECLE $0F02,3579545/32/673
	DECLE $0002,3579545/32/673
	DECLE $0F02,3579545/32/842
	DECLE $0002,3579545/32/842
	DECLE $0F02,3579545/32/1052
	DECLE $0002,3579545/32/1052
	DECLE $0F02,3579545/32/1315
	DECLE $0002,3579545/32/1315
	DECLE $0F02,3579545/32/1644
	DECLE $0002,3579545/32/1644
	DECLE $0F02,3579545/32/2048
	DECLE $0002,3579545/32/2048
	DECLE $0F02,3579545/32/2560
	DECLE $0002,3579545/32/2560
	DECLE $0F02,3579545/32/3200
	DECLE $0002,3579545/32/3200
	DECLE $0F02,3579545/32/4000
	DECLE $0002,3579545/32/4000
	DECLE $0F02,3579545/32/5000
	DECLE $0002,3579545/32/5000
	DECLE $0000

	; Sonido de combustible agotado
sonido_11:
	DECLE $0F08,3579545/32/100
	DECLE $0004,3579545/32/100
	DECLE $0F04,3579545/32/180
	DECLE $0004,3579545/32/180
	DECLE $0000
...
mensaje_3:
	;   "    Space Raid      "
	DECLE $0000,$00ad*8+3,$00ab*8+3,$00a9*8+3,$00a7*8+3,$0033*8+7
	DECLE $0050*8+7,$0041*8+7,$0043*8+7,$0045*8+7,$0000
	DECLE $0032*8+7,$0041*8+7,$0049*8+7,$0044*8+7,$00a6*8+3
	DECLE $00a8*8+3,$00aa*8+3,$00ac*8+3,$0000
	;   "  Oscar Toledo G.   "
	DECLE $0000,$0000*8+3,$0000*8+3,$002F*8+3,$0053*8+3,$0043*8+3
	DECLE $0041*8+3,$0052*8+3,$0000*8+3,$0034*8+3,$004F*8+3
	DECLE $004C*8+3,$0045*8+3,$0044*8+3,$004F*8+3,$0000*8+3
	DECLE $0027*8+3,$000E*8+3,$0000*8+3,$0000*8+3
	;   “                    “
	...
	DECLE $004f*8+6,$0059*8+6,$0000*8+6,$0000*8+6,$0000
        ;   "   Tobie St-Aubin   "
	...
	DECLE $0049*8+6,$004e*8+6,$0000*8+6,$0000*8+6,$0000
	;   “                    “
	DECLE $0000,$0000,$0000,$0000,$0000
	DECLE $0000,$0000,$0000,$0000,$0000
	DECLE $0000,$0000,$0000,$0000,$0000
	DECLE $0000,$0000,$0000,$0000,$0000
	;   "  ROM Mar/03/2014   "
	DECLE $0000,$0000,$0000,$0032*8+3,$002f*8+3,$002d*8+3
	DECLE $0000*8+3,$002d*8+3,$0041*8+3,$0052*8+3,$000f*8+3
	DECLE $0010*8+3,$0013*8+3,$000f*8+3,$0012*8+3,$0010*8+3
	DECLE $0011*8+3,$0014*8+3,$0000*8+3,$0000*8+3

mensaje_5:
	;   "   Beta testing:    "
	DECLE $0000,$0000,$0000,$0000,$0022*8+7,$0045*8+7
	DECLE $0054*8+7,$0041*8+7,$0000*8+7,$0054*8+7,$0045*8+7
	DECLE $0053*8+7,$0054*8+7,$0049*8+7,$004e*8+7,$0047*8+7
	DECLE $001a*8+7,$0000,$0000,$0000
	;   “      cmart604      "
	DECLE $0000,$0000,$0000,$0000,$0000,$0000
